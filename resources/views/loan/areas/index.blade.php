        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form">
                    ...
                    <div class="form-group">
                        <input type="checkbox" name="for_daily_areas"> For daily
                    </div>
                </form>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        $temp = null;
        $colIndex = 1;
        $disable_form_search = 0;

        $element = '#datatable';
        ajaxUrl = "{{url('areas-json')}}";
        ajaxType = "GET";
        ajaxData = {
            for_daily_areas : 1
        };
        _columns = [
            {data : null, title : 'Area name',render(data){
                return data['name'];
            }},
        ...
        function generateTable($element,ajaxUrl,ajaxType,ajaxData,_columns){
            ...
            $('.btn-add').click(function(){
                populate_dropdown("{{url('branches-json')}}",'form#form select[name="branch_id"]','id','name');
            ...
            $('form#form').submit(function(e){
                ...
                var form_data = {
                    ...
                    for_daily_areas : $form.find('input[name="for_daily_areas"]').is(':checked') ? 1 : 0
                };
                $.ajax({
