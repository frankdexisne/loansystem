...
<ul class="breadcrumb">
    ...
    <li class="active">Note Collection Report</li>
</ul>
    ...
    function generateReport(){
        ...
        var tableReport = $('#table-report').DataTable({
            ...
            initComplete: function(datatable,ajax){
                $th = $('#table-report thead > tr').find('th');
                $th.eq(1).html(ajax.titles[0]);
                $th.eq(2).html(ajax.titles[1]);
                $th.eq(3).html(ajax.titles[2]);
                $th.eq(4).html(ajax.titles[3]);
                $th.eq(5).html(ajax.titles[4]);
                $th.eq(6).html(ajax.titles[5]);
                $th.eq(7).html(ajax.titles[6]);
                $th.eq(8).html(ajax.titles[7]);
            }
        });
