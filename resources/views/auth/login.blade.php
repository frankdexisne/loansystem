...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="{{asset('ace-master')}}/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="{{asset('ace-master')}}/css/ace-part2.min.css" />
		<![endif]-->
	...
	<body class="login-layout blur-login">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Loan</span>
									<span class="white" id="id-text2">System</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; {{env('APP_ALIAS')}}</h4>
							</div>
		...
		<!--[if IE]>
<script src="{{asset('ace-master')}}/js/jquery-1.11.3.min.js"></script>
<![endif]-->
